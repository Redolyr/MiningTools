	...
	public Recipe(FMLPreInitializationEvent event) {
		if (Proxy.proxy.Config().RecipeIO == true) {
			...
			try {
				...
				data1.setComment("Mining Tools: Low Recipe");
				data2.setComment("Mining Tools: High Recipe");
				data3.setComment("Stone Tools Upgrade mode recipe");
				data4.setComment("Iron Tools Upgrade mode recipe");
