...
//    	return String().ResourceCode.replace(":", "") + ":";
    ...
    public String addEnumChatFormatingColorText(boolean on_off, EnumChatFormatting enumChatFormating, String formatingText)
    {
        if (on_off)
        {
            addName(EnumChatFormatting.AQUA + localize(formatingText));
        }
    ...
    public void addInfomationText(List par1par3List, String Text, String Text2)
    {
        if (on_off == true)
        {
            par1par3List.add(EnumChatFormatting.YELLOW + localize(Text) + ": " + EnumChatFormatting.AQUA + localize(Text2));
        }
    ...
    public void addInfomationText(List par1par3List, String Text)
    {
        if (on_off == true)
        {
            par1par3List.add(EnumChatFormatting.YELLOW + localize(Text));
        }
    ...
    public void addInfomationText(List par1par3List, String Text, String Text2, String Text3)
    {
        if (on_off == true)
        {
            par1par3List.add(EnumChatFormatting.RED + localize(Text) + EnumChatFormatting.YELLOW + localize(Text2) + EnumChatFormatting.AQUA + localize(Text3));
        }
    ...
    public void addInfomationText(List par1par3List, String Text, String Text2, String Text3, String Text4)
    {
        if (on_off == true)
        {
            par1par3List.add(EnumChatFormatting.YELLOW + localize(Text) + ": " + EnumChatFormatting.AQUA + localize(Text2) + ", " + EnumChatFormatting.YELLOW + localize(Text3) + ": " + EnumChatFormatting.AQUA + localize(Text4));
        }
...
//        Minecraft.getMinecraft().renderEngine.bindTexture(MiningToolsLocation("textures/models/" + path + ".png"));
        Minecraft.getMinecraft().renderEngine.bindTexture(MiningToolsLocation(String.format("textures/%s/%s.png", "models", path)));
    }
    ...
    public void EnderDyeInformation(List par1par3List, String Text)
    {
        ...
        {
            par1par3List.add(EnumChatFormatting.BLACK + localize(Text));
        }
        if (on_off == true || Text == "red")
        {
            par1par3List.add(EnumChatFormatting.RED + localize(Text));
        }
        if (on_off == true || Text == "green")
        {
            par1par3List.add(EnumChatFormatting.GREEN + localize(Text));
        }
        if (on_off == true || Text == "blue")
        {
            par1par3List.add(EnumChatFormatting.BLUE + localize(Text));
        }
        if (on_off == true || Text == "purple")
        {
            par1par3List.add(EnumChatFormatting.LIGHT_PURPLE + localize(Text));
        }
        if (on_off == true || Text == "gray")
        {
            par1par3List.add(EnumChatFormatting.GRAY + localize(Text));
        }
        ...
        {
            par1par3List.add(EnumChatFormatting.WHITE + localize(Text));
        }
        if (on_off == false)
        {
            par1par3List.add(Text);
...
//            	return FancyFastLink();
    ...
    public void addNameForObject(boolean on_off, EnumChatFormatting enumChatFormatteing, Object obj, String en_US, String de_DE, String ja_JP)
    {
        if (on_off)
        {
    ...
    public Integer getColorFromItem(Integer R, Integer G, Integer B)
    {
    	...
    	{
    		return color = getSubColorChart(R, G, B);
    	}
    	return color;
    }
